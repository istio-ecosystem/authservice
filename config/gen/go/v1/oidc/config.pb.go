...
type RedisConfig struct {
	...
	// For Sentinel URIs, credentials before the host authenticate to Sentinel. The `username` and
	// `password` query parameters authenticate to the Redis server.
	...
	// The username to use when connecting to Redis Sentinel. It can also be configured in the `server_uri`.
	SentinelUsername string `protobuf:"bytes,6,opt,name=sentinel_username,json=sentinelUsername,proto3" json:"sentinel_username,omitempty"`
	// Types that are assignable to SentinelPasswordConfig:
	//
	//	*RedisConfig_SentinelPassword
	//	*RedisConfig_SentinelPasswordFile
	SentinelPasswordConfig isRedisConfig_SentinelPasswordConfig `protobuf_oneof:"sentinel_password_config"`
}
...
func (x *RedisConfig) GetSentinelUsername() string {
	if x != nil {
...
func (m *RedisConfig) GetSentinelPasswordConfig() isRedisConfig_SentinelPasswordConfig {
	if m != nil {
		return m.SentinelPasswordConfig
	}
	return nil
}

func (x *RedisConfig) GetSentinelPassword() string {
	if x, ok := x.GetSentinelPasswordConfig().(*RedisConfig_SentinelPassword); ok {
		return x.SentinelPassword
	}
	return ""
}

func (x *RedisConfig) GetSentinelPasswordFile() string {
	if x, ok := x.GetSentinelPasswordConfig().(*RedisConfig_SentinelPasswordFile); ok {
...
type isRedisConfig_SentinelPasswordConfig interface {
	isRedisConfig_SentinelPasswordConfig()
}

type RedisConfig_SentinelPassword struct {
	// The password to use when connecting to Redis Sentinel. It can also be configured in the `server_uri`.
	SentinelPassword string `protobuf:"bytes,7,opt,name=sentinel_password,json=sentinelPassword,proto3,oneof"`
}

type RedisConfig_SentinelPasswordFile struct {
	// The file containing the password to use when connecting to Redis Sentinel.
	// This is useful when the password is stored in a Kubernetes Secret.
	SentinelPasswordFile string `protobuf:"bytes,8,opt,name=sentinel_password_file,json=sentinelPasswordFile,proto3,oneof"`
}

func (*RedisConfig_SentinelPassword) isRedisConfig_SentinelPasswordConfig() {}

func (*RedisConfig_SentinelPasswordFile) isRedisConfig_SentinelPasswordConfig() {}
...
var file_v1_oidc_config_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x62, 0x6c, 0x65, 0x22, 0x88, 0x06, 0x0a, 0x0b, 0x52, 0x65, 0x64, 0x69, 0x73, 0x43,
	...
	,
	...
	,
...
func file_v1_oidc_config_proto_init() {
	...
	file_v1_oidc_config_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*RedisConfig_SentinelPassword)(nil),
		(*RedisConfig_SentinelPasswordFile)(nil),
	}
