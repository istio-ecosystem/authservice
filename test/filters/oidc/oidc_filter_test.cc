...
const common::http::TransportSocketOptions kDefaultTransportSocketOpts{
    .ca_cert_ = "some-ca", .verify_peer_ = true};
...
TEST_F(
  ...
  EXPECT_CALL(*mocked_http,
              Post(Eq(token_uri), _, _, Eq(kDefaultTransportSocketOpts),
