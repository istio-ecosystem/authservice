...
TokenResponse &SessionData::GetTokenResponse() {
  return token_response_;
}

uint32_t SessionData::GetTimeAdded() {
  return time_added_;
}

uint32_t SessionData::GetTimeMostRecentlyAccessed() {
  return time_accessed_;
}

void SessionData::SetTimeMostRecentlyAccessed(uint32_t time_accessed) {
